...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-royal-green relative flex items-center justify-center overflow-hidden px-4 py-12">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(212,175,55,0.12)_0%,transparent_50%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,rgba(18,107,73,0.3)_0%,transparent_50%)]" />
      ...
      <motion.div
        ...
        className="absolute top-1/4 right-1/4 w-72 h-72 bg-soft-gold/10 rounded-full blur-3xl" />
      ...
      <motion.div
        ...
        className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-royal-green-light/20 rounded-full blur-3xl" />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a
                  href="#"
                  className="text-soft-gold/80 hover:text-soft-gold text-xs transition-colors">
            ...
            <div className="flex items-center gap-3">
              <input
                type="checkbox"
                id="remember"
                className="w-4 h-4 rounded border-white/20 bg-white/5 text-soft-gold focus:ring-soft-gold/30 accent-soft-gold" />
